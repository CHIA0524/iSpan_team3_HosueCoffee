...
('咖啡豆篇coffeebean','Handsome','想要煮出與咖啡廳一樣的美味咖啡？你需要注意的4個技巧','技巧1. 決定沖煮架構
...
美學大師蔣勳曾說「『酸味』、『苦味』跟人生搭在一起，最後都會變成生命的記憶」。想想咖啡不正如人生，對於喜歡咖啡的人而言，咖啡豆特有的酸味或烘培後漸漸產生的苦味都是迷人的特色，讓後續的甘韻風味表現更顯層次。跟當時剛第三度連霸「台灣咖啡大師」冠軍的吳則霖Berg從開始著迷義式咖啡的大學時代聊起，發現成功真的不是偶然，而那些旁人聽起來覺得辛苦的過程，在他口中都是輕描淡寫的往事，甚至是甜甜的回憶。
' ,'4','2022-05-31','4celebrity40006'),

('好物分享篇share','嘉米爾頓','從必需品到奢侈品的三波咖啡革命，顛覆咖啡世界的智能化浪潮','', '5','2022-03-06','5share50006'),

('咖啡篇coffee','Handsome','說到綠咖啡，你會想到什麼呢？','
看看別人，再想想自己，會發現問題的核心其實就在你身旁。綠咖啡絕對是史無前例的。
面對如此難題，我們必須設想周全。在人類的歷史中，我們總是盡了一切努力想搞懂綠咖啡。克里索斯爾深信，友誼有許多名字，然而一旦有青春和美貌介入，友誼便被稱作愛情，而且被神化為最美麗的天使。這不禁令我深思。在人生的歷程中，綠咖啡的出現是必然的。阿基達莫斯深信，哲學是對習慣的攻擊性武器。這不禁令我深思。
...
('500001','
影響Body的重要因素<br/>
怎麼樣的Body會被形容輕盈，什麼樣的Body又會被描述為厚重呢？其實不論生豆品種、生豆處理法乃至烘焙與配豆，以及沖煮方式，都與Body息息相關。<br/>
...
('500002','
康有為說過一句經典的名言，虛驕自大者敗之媒，卑飛使用翼者擊之漸。這段話讓我的心境提高了一個層次。我們普遍認為，若能理解透徹核心原理，對其就有了一定的了解程度。奧勒利烏斯說過一句著名的話，善的源泉是在內心，如果你挖掘，它將汩汩地湧出。這句話讓我們得到了一個全新的觀點去思考這個問題。我們要從本質思考，從根本解決問題。咖啡改變了我的命運。了解清楚咖啡到底是一種怎麼樣的存在，是解決一切問題的關鍵。在這種不可避免的衝突下，我們必須解決這個問題。話雖如此，經過上述討論，俗話說的好，掌握思考過程，也就掌握了咖啡。儘管如此，我們仍然需要對咖啡保持懷疑的態度。咖啡可以說是有著成為常識的趨勢。<br/>
','2pourover20010'),
...
('500003','
曬處理法的進擊<br/>
精品莊園百家爭鳴，爭風、爭風味，國際市場上各莊園爭奇豔今，即使是曬處理法，也發展出各種不同的式。對於曬處理法，最重要的莫過於果實熟度與乾燥程度，近完熟、含糖量極的咖啡櫻桃，經過各種乾燥式，產具有豐富層次的風味變化。
...
('500004','
從研究所時Berg開始改裝行動咖啡三輪車，他說「當你做自己喜歡的事時，你就不會覺得辛苦，因為你也不覺得自己在工作」。
...
('500004','
回想起2008年在丹麥觀摩世界咖啡大賽，讓Berg在心中種下一個願望「我也想站在台上，和大家分享我的咖啡。」回台隔年他就報名了台灣的比賽，沒經驗的他在初賽就挑戰被刷掉，但他不但沒受到打擊，更將評分視為專業的建議，抱著增進技術的決心，一年一年的回到賽台上，直到2011年開店讓他開始在正式吧檯上大量訓練，再次報名就入圍決賽。
以一期一會的心念沖煮每杯咖啡
