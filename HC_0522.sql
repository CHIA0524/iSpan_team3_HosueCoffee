...
INSERT INTO `user_ask`(`fk_user_id`,`ask_type`, `main`,`ask`,`ans`)
VALUES
('1','優惠活動','買一送一','請問買一送一要同品項嗎?',''),
('1','運費相關','運費','請問合計運費會因為重量增加而改變運費，還是單次運費就是固定的呢?','不會喔，單筆若一起寄送，運費都是固定的，不會因為重量增加而改變，但有可能體積超出寄送規定，而分開寄出，若發生此問題，客服會主動向您聯絡'),
('2','商品相關','大小包','咖啡豆有分大小包嗎?',''),
('3','其他','我強不強','我是不是最強的車手?','是，你是'),
('4','其他','車隊問題','今年會在哪個車隊','Mercedes-AMG Petronas F1 Team'),
('5','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('6','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('7','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('8','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('9','其他','假世界冠軍','Max不是的世界冠軍','沒錯他不是'),
('10','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('11','其他','假世界冠軍','Max不是真的世界冠軍',''),
('12','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('13','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('14','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('15','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('16','其他','假世界冠軍','Max不是真的世界冠軍',''),
('17','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('18','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('19','其他','假世界冠軍','Max不是真的世界冠軍','沒錯他不是'),
('20','其他','假世界冠軍','Max不是真的世界冠軍',''),
('21','其他','最多世界冠軍','我爸是不是擁有最多世界冠軍的車手',''),
('22','其他','打折?','世界冠軍買咖啡有打折嗎?',''),
('23','其他','代言問題','我想代言你們品牌方便嗎?',''),
('24','其他','適用','有賣試用包嗎?','');
